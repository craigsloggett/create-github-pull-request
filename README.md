...
**PR body**:
```
Refreshes the pinned govulncheck version used by `make scan`.
Generated by the scheduled `update-govulncheck` workflow.
```
**Commit message**: the entire block, preserved verbatim.
