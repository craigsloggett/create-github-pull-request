...
| Field          | Value                                                                                                                      |
| -------------- | -------------------------------------------------------------------------------------------------------------------------- |
| PR Title       | `chore(build): Update govulncheck to <version>`                                                                            |
| PR Body        | Refreshes the pinned govulncheck version used by `make scan`.<br>Generated by the scheduled `update-govulncheck` workflow. |
| Commit Message | The entire block above, preserved verbatim.                                                                                |
